...
func migrations() []tableMigration {
	return []tableMigration{
		...
		migrateTable[model.OfficialAsset]("official_assets"),
		migrateTable[model.OfficialAssetMedia]("official_asset_media"),
		migrateTable[model.UserOfficialAssetFavorite]("user_official_asset_favorites"),
		migrateTable[model.UserOfficialAssetUse]("user_official_asset_uses"),
