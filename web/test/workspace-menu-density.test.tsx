...
test("9gLab personal and official galleries retain the shared comfortable density", () => {
    ...
    expect(page).toContain('"--assets-grid-columns": gridDensity');
    expect(css).toContain("minmax(min(100%, var(--collection-grid-min-width, 224px)), 1fr)");
    expect(globals).toContain("repeat(var(--assets-grid-columns, 4), minmax(0, 1fr))");
