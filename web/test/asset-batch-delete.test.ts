...
beforeEach(async () => {
    ...
    const originals = { getItem: localforage.getItem, setItem: localforage.setItem, removeItem: localforage.removeItem };
    ...
    localforage.removeItem = async (key: string) => { values.delete(key); };
    restoreStorage = () => Object.assign(localforage, originals);
