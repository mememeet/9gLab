...
export const DEFAULT_CLASSIC_SKIN: SkinDefinition = {
    ...
    tokens: {
        light: {
            ...
            control: "#ffffff",
            controlHover: "#f4f4f6",
            controlActive: "#ececf0",
            controlBorder: "#dedee3",
            controlFocus: "#6d6cff",
            controlDisabledBackground: "#f2f2f4",
            controlDisabledForeground: "#a1a1aa",
            switchChecked: "#6d6cff",
            switchCheckedHover: "#5f5eea",
            switchCheckedHandle: "#ffffff",
            switchUnchecked: "#c4c4ca",
            switchUncheckedHover: "#aeaeb5",
            ...
            selected: "#efefff",
            selectedHover: "#e6e5ff",
            selectedActive: "#dcdbff",
            selectedForeground: "#3f3e9e",
            icon: "#3f3f46",
            iconMuted: "#a1a1aa",
            iconActive: "#6d6cff",
            success: "#16a34a",
            ...
            info: "#6d6cff",
            workspace: "#ffffff",
            workspaceGrid: "#efeff1",
            adminBackground: "#f4f4f6",
            adminSurface: "#ffffff",
            adminSubtle: "#f8f8fa",
            adminStrong: "#ececf0",
        ...
        dark: {
            ...
            control: "#1d1d1f",
            controlHover: "#26262a",
            controlActive: "#303036",
            controlBorder: "#3f3f46",
            controlFocus: "#8b8aff",
            controlDisabledBackground: "#202024",
            controlDisabledForeground: "#71717a",
            switchChecked: "#8b8aff",
            switchCheckedHover: "#a09fff",
            switchCheckedHandle: "#18181b",
            switchUnchecked: "#52525b",
            switchUncheckedHover: "#64646f",
            switchUncheckedHandle: "#f4f4f5",
            primary: "#f4f4f5",
            primaryHover: "#ffffff",
            primaryActive: "#e4e4e7",
            primaryForeground: "#18181b",
            selected: "#292845",
            selectedHover: "#343357",
            selectedActive: "#3f3e68",
            selectedForeground: "#e5e5ff",
            icon: "#d4d4d8",
            iconMuted: "#71717a",
            iconActive: "#8b8aff",
            success: "#4ade80",
            ...
            info: "#8b8aff",
            workspace: "#161616",
            workspaceGrid: "#222225",
            adminBackground: "#111113",
            adminSurface: "#18181a",
            adminSubtle: "#1d1d20",
            adminStrong: "#27272a",
            authBackground: "#111113",
            authPanel: "#18181a",
            authCard: "#1d1d20",
            authAccent: "#8b8aff",
            authMuted: "#a1a1aa",
        },
        buttons: { light: { ...DEFAULT_BUTTON_GRADIENT, mode: "solid" }, dark: { ...DEFAULT_BUTTON_GRADIENT, mode: "solid" } },
        components: {
            buttonRadius: 8,
            inputRadius: 8,
            cardRadius: 12,
...
const MANAGED_VARIABLES = [
    ...
    "--text-tertiary",
    "--text-on-media",
    "--home-sidebar-primary-text",
    "--home-sidebar-secondary-text",
    "--home-sidebar-section-text",
    "--accent",
    "--accent-foreground",
    "--destructive",
    "--destructive-hover",
...
function normalizeButtonFill(value: unknown, skinID: string): SkinButtonFill {
    return isSkinButtonFill(value) ? { ...value } : { ...DEFAULT_BUTTON_GRADIENT, mode: "solid" };
}
...
export function skinCSSVariables(skin: SkinDefinition, mode: SkinThemeMode): Record<string, string> {
    ...
    const classicTypography = skin.id === "classic";
    const textTertiary = classicTypography ? (mode === "dark" ? "#ffffff6b" : "#00000052") : `color-mix(in srgb, ${color.text} 42%, transparent)`;
    const sidebarPrimary = classicTypography ? (mode === "dark" ? "#ffffffd6" : "#000000b3") : `color-mix(in srgb, ${color.text} 84%, transparent)`;
    const sidebarSecondary = classicTypography ? (mode === "dark" ? "#ffffffcc" : "#000000a6") : `color-mix(in srgb, ${color.text} 72%, transparent)`;
    return {
        ...
        "--home-sidebar-primary-text": sidebarPrimary,
        "--home-sidebar-secondary-text": sidebarSecondary,
        "--home-sidebar-section-text": color.textMuted,
        ...
        "--workspace-accent": color.controlFocus,
        "--workspace-accent-soft": `color-mix(in srgb, ${color.controlFocus} 12%, transparent)`,
